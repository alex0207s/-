...
def preprocess_input(image):
    ...
    #mean = (0.46512052, 0.42602176, 0.4593257)
    #std = (0.24830208, 0.26134835, 0.25621281)
    #image -= mean
    #image /= std
    return image
...
def focal(alpha=0.25, gamma=2):## gamma=2
    def _focal(y_true, y_pred):
        ...
        # 找出存在目标的先验框
        indices_for_object        = backend.where(keras.backend.equal(anchor_state, 1)) ## 1
